import { type ResultOf, type VariablesOf, readFragment } from './graphql/operations/write-graphql';
...
} from './graphql/operations/write/mutations';
import type { CreateUserInput, UpdateUserInput } from './domains/user/models/User';
import type { IWriteClient } from '@cqrs-framework/client';

// Type-safe GraphQL write client
export class TypedWriteClient implements IWriteClient {
