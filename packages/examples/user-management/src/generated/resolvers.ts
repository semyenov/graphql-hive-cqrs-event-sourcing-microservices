// GraphQLResolveInfo type definition for resolver context
...
export type ResolversTypes = {
  ...
  CreateUserInput: ResolverTypeWrapper<import("../domains/user/models/User").CreateUserInput>;
  ...
  Error: ResolverTypeWrapper<{ field: string | null; message: string; code?: string }>;
  ID: ResolverTypeWrapper<Partial<Scalars['ID']['output']>>;
  Int: ResolverTypeWrapper<Partial<Scalars['Int']['output']>>;
  Mutation: ResolverTypeWrapper<import("../server/server").GraphQLRootValue>;
  Query: ResolverTypeWrapper<import("../server/server").GraphQLRootValue>;
  String: ResolverTypeWrapper<Partial<Scalars['String']['output']>>;
  UpdateUserInput: ResolverTypeWrapper<import("../domains/user/models/User").UpdateUserInput>;
  ...
  User: ResolverTypeWrapper<import("../domains/user/models/User").User>;
...
export type ResolversParentTypes = {
  ...
  Mutation: import("../server/server").GraphQLRootValue;
  Query: import("../server/server").GraphQLRootValue;
...
export type CreateUserPayloadResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['CreateUserPayload'] = ResolversParentTypes['CreateUserPayload']> = {
...
export type DeleteUserPayloadResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['DeleteUserPayload'] = ResolversParentTypes['DeleteUserPayload']> = {
  errors?: Resolver<Maybe<ReadonlyArray<ResolversTypes['Error']>>, ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ErrorResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['Error'] = ResolversParentTypes['Error']> = {
  field?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MutationResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
...
export type QueryResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
...
export type UpdateUserPayloadResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['UpdateUserPayload'] = ResolversParentTypes['UpdateUserPayload']> = {
  errors?: Resolver<Maybe<ReadonlyArray<ResolversTypes['Error']>>, ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  user?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type UserResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
...
export type UserListResolvers<ContextType = import("../server/server").GraphQLContext, ParentType extends ResolversParentTypes['UserList'] = ResolversParentTypes['UserList']> = {
...
export type Resolvers<ContextType = import("../server/server").GraphQLContext> = {
