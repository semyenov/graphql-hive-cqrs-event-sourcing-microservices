import { CQRSClientBase } from '@cqrs-framework/client';
...
// User-specific CQRS client that extends the framework base
export class CQRSClient extends CQRSClientBase<TypedReadClient, TypedWriteClient> {
